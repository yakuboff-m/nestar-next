...
const CommunityBoards = () => {
	...
	/** APOLLO REQUESTS **/
	const { loading: getNewsArticlesLoading, data: getNewsArticlesData, error: getNewsArticlesError, refetch: getNewsArticlesRefetch } = useQuery(GET_BOARD_ARTICLES, {
	...
	const { loading: getFreeArticlesLoading, data: getFreeArticlesData, error: getaFreeArticlesError, refetch: getFreeArticlesRefetch } = useQuery(GET_BOARD_ARTICLES, {
		fetchPolicy: "network-only",
